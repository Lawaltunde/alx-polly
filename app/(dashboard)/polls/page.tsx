...
export default async function PollsPage() {
  ...
  <h1 className="text-4xl font-bold text-foreground">My Polls</h1>
  ...
  {fetchError ? (
      ...
      {polls.map((poll) => (
        ...
        <Card className="poll-card bg-card border border-border rounded-lg shadow-md overflow-hidden">
                <CardHeader>
        ...
        <div className="flex flex-col items-center justify-center text-center py-20">
          <h2 className="text-3xl font-bold text-foreground mb-4">No Polls Yet</h2>
          <p className="text-muted-foreground mb-8 max-w-md">
